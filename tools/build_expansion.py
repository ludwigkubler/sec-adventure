...
PUZZLES = {
    "lucchetto_scrigno": {
        ...
        "testo": "Lo scrigno antico ai piedi del trono. Quattro rotelle, ognuna con simboli misteriosi. Una iscrizione: 'IL SOLE NASCE A ORIENTE, IL TRIANGOLO SACRO PUNTA AL CIELO, AL TERZO GIORNO IL RE GIUNSE, E LA TERRA LO ACCOLSE.'",
        "rotelle": [
            ["☉", "☽", "★", "✦"],
            ["▲", "■", "●", "◆"],
            ["I", "II", "III", "IV"],
