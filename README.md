...
**Play online**: [GitHub Pages release](https://ludwigkubler.github.io/submachine/) *(after deploy)*

**Play locally**:
```bash
git clone https://github.com/ludwigkubler/submachine.git
cd submachine
...
- **36 hand-crafted rooms** with atmospheric backgrounds generated by Stable Diffusion XL
- **59 items** with hand-drawn SVG icons, 13 of which are lore collectibles with a full codex
...
- **36 stanze disegnate con cura** con sfondi atmosferici generati da Stable Diffusion XL
- **59 oggetti** con icone SVG, 13 dei quali collezionabili con codex narrativo
...
- [ ] v1.1 — Translate remaining dialogues + enable console port research
- [ ] v1.2 — Add controller support
- [ ] v1.3 — Mobile responsive layout
